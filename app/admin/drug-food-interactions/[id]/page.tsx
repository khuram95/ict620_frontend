...
export default function DrugFoodInteractionDetailPage({ params }: { params: { id: string } }) {
  ...
  const handleDelete = async () => {
    try {
      await drugFoodInteractionApi.delete(params.id)
    ...
    return (
      <div className="p-8">
        <div className="flex items-center gap-2 mb-6">
          <Link href="/admin/drug-food-interactions" className="text-gray-600 hover:text-gray-900">
            <ArrowLeft className="h-5 w-5" />
          </Link>
          <h1 className="text-2xl font-bold">Drug-Food Interaction Details</h1>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href={`/admin/drug-food-interactions/${params.id}/edit`} passHref>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Food Item</CardTitle>
          </CardHeader>
          <CardContent>
            <p>{interaction.food_name || `ID: ${interaction.food_id}`}</p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span>{interaction.df_interaction_id}</span>
              </div>
              <div className="flex justify-between">
