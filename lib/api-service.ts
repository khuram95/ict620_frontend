...
// --- Mock Data (For development/testing purposes - not used by API functions below) ---
...
// Add other mock data arrays if needed (allergies, references, schedules, users, interactions)
